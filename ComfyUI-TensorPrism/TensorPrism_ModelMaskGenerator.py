...
class TensorPrism_ModelMaskGenerator:
    ...
    RETURN_NAMES = ("model_mask",)
    FUNCTION = "generate_model_mask"
    CATEGORY = "Tensor Prism/Mask"

    def generate_model_mask(self, mask_type, intensity, reference_model, 
...
# Updated merge node to work with MODEL_MASK
class TensorPrism_WeightedMaskMerge:
    ...
    def merge_models(self, model_A, model_B, model_mask, merge_ratio):
        """
        ...
        # Get mask dictionary
        mask_dict = model_mask["mask_dict"]
